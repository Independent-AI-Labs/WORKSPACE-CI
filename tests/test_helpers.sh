...
_link_lib_files() {
    local _ci_dir="$1"
    local f src
    for f in ci.sh ci_owner.sh ci_deploy_lock.sh ci_helpers.sh ci_config_paths.sh ci_catalog.sh ci_exemptions.sh checks.sh checks_*.sh check_module_size.sh \
