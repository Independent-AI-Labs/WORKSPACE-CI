...
for _mod in ci.sh ci_exemptions.sh checks_core.sh check_module_size.sh checks_commit.sh checks_files.sh checks_deletions.sh checks_coverage.sh checks_compliance.sh checks_silent.sh checks_secrets.sh checks_security.sh checks_quality.sh checks_dead_code.sh; do
